import { SucursalPagoMetodoRepository } from '#db/repositories.js'
...
const find = async (req, res) => {
    try {
        ...
        let data = await SucursalPagoMetodoRepository.find(qry, true)
...
const update = async (req, res) => {
    try {
        ...
        // --- ACTUALIZAR --- //
        const updated = await SucursalPagoMetodoRepository.update(
            { id },
