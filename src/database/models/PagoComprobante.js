...
Empresa.hasMany(PagoComprobante, { foreignKey: 'empresa', as: 'pago_comprobantes', onDelete: 'RESTRICT' })
PagoComprobante.belongsTo(Empresa, { foreignKey: 'empresa', as: 'empresa1' })
