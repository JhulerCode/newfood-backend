...
Sucursal.hasMany(ProduccionArea, { foreignKey: 'sucursal', as: 'produccion_areas', onDelete: 'RESTRICT' })
ProduccionArea.belongsTo(Sucursal, { foreignKey: 'sucursal', as: 'sucursal1' })
