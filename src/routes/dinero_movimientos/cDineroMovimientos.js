...
//                     model: Comprobante,
//                     as: 'comprobante1',
//                     attributes: ['id', 'doc_tipo', 'serie', 'numero', 'serie_correlativo', 'monto', 'estado'],
//                     include: {
...
//                                     tipo: pago_comprobantesMap[a.comprobante1.doc_tipo].nombre,
//                                     monto: Number(a.monto),
//                                 })
//                             }
//                             else {
...
//                             const i = send.venta_comprobantes.findIndex(b => b.id == a.comprobante1.doc_tipo)
//                             if (i === -1) {
//                                 send.venta_comprobantes.push({
//                                     id: a.comprobante1.doc_tipo,
//                                     nombre: pago_comprobantesMap[a.comprobante1.doc_tipo].nombre,
//                                     monto: Number(a.monto),
//                                     cantidad: 1
//                                 })
//                             }
